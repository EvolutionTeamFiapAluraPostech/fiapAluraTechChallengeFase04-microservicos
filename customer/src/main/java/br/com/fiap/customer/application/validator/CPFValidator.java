...
import static br.com.fiap.customer.domain.fields.CustomerFields.CUSTOMER_CPF_FIELD;
...
public class CPFValidator {
  ...
  private void throwInvalidCpfException(String cnpjValue) {
    throw new ValidatorException(new FieldError(this.getClass().getSimpleName(), CUSTOMER_CPF_FIELD,
