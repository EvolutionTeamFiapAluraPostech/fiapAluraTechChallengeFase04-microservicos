package br.com.fiap.customer.infrastructure.httpclient;

import br.com.fiap.customer.CustomerApplication;
...
public class GetCoordinatesFromCepRequest {
  ...
  private void handlingExceptionFromGettingCoordinatesByCep(String cep, WebClientResponseException e) {
    ...
    CustomerApplication.logger.error(error);
  }
