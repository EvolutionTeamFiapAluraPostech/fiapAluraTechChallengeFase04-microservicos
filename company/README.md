...
Repositório do projeto da pós tech da FIAP/ALURA. Desenvolvimento de um microserviço de gerenciamento de empresas.

## Requisitos:
1. Este serviço será responsável por todas as operações relacionadas a empresa, incluindo a criação, leitura, atualização e exclusão de registros de empresas (CRUD).
