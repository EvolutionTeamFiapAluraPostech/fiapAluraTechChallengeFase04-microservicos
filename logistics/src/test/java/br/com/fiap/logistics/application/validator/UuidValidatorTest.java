...
import static br.com.fiap.logistics.application.validator.UuidValidator.UUID_WITH_INVALID_UUID_MESSAGE;
...
class UuidValidatorTest {
  ...
  void shouldThrowExceptionWhenIdIsInvalid(String invalidUuid) {
    assertThatThrownBy(() -> uuidValidator.validate(invalidUuid))
        ...
        .hasMessageContaining(UUID_WITH_INVALID_UUID_MESSAGE.formatted(invalidUuid));
  }
}
